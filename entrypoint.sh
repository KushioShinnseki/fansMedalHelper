...
"0")
    ...
    git remote set-url origin https://github.com/yokinanya/fansMedalHelper.git
    ;;
"1")
    # https://ghproxy.com/
    echo -e "${Green} [INFO] 使用镜像源-GHProxy ${Plain}"
    git remote set-url origin https://mirror.ghproxy.com/https://github.com/yokinanya/fansMedalHelper.git
    ;;
"2")
    # http://fastgit.org/
    echo -e "${Green} [INFO] 使用镜像源-FastGIT ${Plain}"
    git remote set-url origin https://hub.fastgit.xyz/yokinanya/fansMedalHelper.git
    ;;
*)
    echo -e "${Green} [INFO] 使用源-GitHub ${Plain}"
    git remote set-url origin https://github.com/yokinanya/fansMedalHelper.git
